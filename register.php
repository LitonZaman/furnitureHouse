...
//			$recaptcha = new \ReCaptcha\ReCaptcha('6LevO1IUAAAAAFCCiOHERRXjh3VrHa5oywciMKcw', new \ReCaptcha\RequestMethod\SocketPost());
        $recaptcha = new \ReCaptcha\ReCaptcha('6LevO1IUAAAAAFCCiOHERRXjh3VrHa5oywciMKcw', new \ReCaptcha\RequestMethod\CurlPost());
        ...
        if ($row['numrows'] > 0) {
            ...
            try {
                ...
                $message = "
						...
						<a href='http://localhost/furniture_shop/activate.php?code=" . $code . "&user=" . $userid . "'>Activate Account</a>
					";
                ...
                try {
                    ...
                    //Content
                    $mail->isHTML(true);
                    $mail->Subject = 'Furniture House Sign Up';
                    $mail->Body = $message;
